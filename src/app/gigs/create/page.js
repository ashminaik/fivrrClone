...
export default function CreateGigPage() {
        ...
        return (
            <div className="create-gig-page container">
                <div className="empty-state">
                    ...
                    <h3>Access Denied</h3>
                    <p>Only freelancers can create gigs. Please sign up as a freelancer to get started.</p>
                </div>
            </div>
        );
    }
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(resp.error || 'Failed to create gig');
            }
        } catch (err) {
    ...
    return (
        <div className="create-gig-page container">
            ...
            <p className="subtitle">Share your skills with the world</p>
